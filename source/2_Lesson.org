...
:HTML_CONTAINER_CLASS: learn
:END:
- We can use pulleys to increase or decrease the speed of rotarty motion.
...
:HTML_CONTAINER_CLASS: badge
:END:
- Create an assembly of your driver and driven pulleys and link them with a belt.
- Animate the pulleys using a motor for the driven pulley.
